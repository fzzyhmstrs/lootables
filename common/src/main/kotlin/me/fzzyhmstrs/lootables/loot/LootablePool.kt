    ...
    private val conditions: List<LootCondition> = listOf())
{
    ...
    fun canApply(context: LootContext): Boolean {
        val entity = context.get(LootContextParameters.THIS_ENTITY).nullCast<ServerPlayerEntity>() ?: return false
        val uses = LootablesData.getUses(id, entity)
    ...
    internal companion object {
        ...
        @Suppress("CustomRegExpInspection")
