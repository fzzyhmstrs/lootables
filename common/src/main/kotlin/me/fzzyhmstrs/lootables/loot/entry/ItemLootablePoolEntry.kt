...
class ItemLootablePoolEntry private constructor(private val itemEntryStack: ItemEntryStack, private val dropItems: Boolean = false): LootablePoolEntry {
     ...
     */
    @JvmOverloads
    constructor(item: Item, count: LootableNumber, components: ComponentChanges, dropItems: Boolean = false): this(ItemEntryStack(@Suppress("DEPRECATION") item.registryEntry, count, components), dropItems)
